...
![(рис. 1. 1-4 пункты задания лабораторной)](image/1.jpg){ #fig:001 width=70% height=70% }
...
![(рис. 2. 5-7 пункты задания лабораторной)](image/2.jpg){ #fig:002 width=70% height=70% }

7. Сравните полученную информацию с содержимым файла /etc/group :

![(рис. 3. 8 пункт задания лабораторной)](image/3.jpg){ #fig:003 width=70% height=70% }
...
![(рис. 5. 10-11 пункты задания лабораторной)](image/5.jpg){ #fig:005 width=70% height=70% }
